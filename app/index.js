...
(async () => {
  ...
  await fs.writeFile(
    "./high-mileage-vehicle.json",
    JSON.stringify(highMileageVehicle)
  );
})();
...
(async () => {
  ...
  await fs.writeFile("./yahoo-emails.json", JSON.stringify(yahooEmails));
})();
...
(async () => {
  ...
  await fs.writeFile(
    "./total-mileage-illinois.json",
    JSON.stringify(totalMileageIL)
  );
})();
